    ...
    model(0)
{
    ...
    ui->sendTo->setPlaceholderText(tr("Enter recipient DigitalNote smsginfo (e.g. dZFKfe559tX7LA8BDMeiPH3C8DbpTJ92Y8:dZv7b41skzqG8cj2d5S56MG1hVQbcK8jMoorX8Wdmf5v)"));
