...
/** DigitalNote unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class DigitalNoteUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit DigitalNoteUnits(QObject *parent);
...
typedef DigitalNoteUnits::Unit DigitalNoteUnit;
