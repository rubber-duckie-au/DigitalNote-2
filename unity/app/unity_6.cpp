//ORIGINAL_PATH: src/netbase.cpp----src/ecwrapper.cpp----src/key.cpp----src/pubkey.cpp----src/script.cpp----src/scrypt.cpp----src/chain.cpp----src/miner.cpp----src/checkpoints.cpp----src/addrman.cpp----src/db.cpp----src/wallet.cpp
