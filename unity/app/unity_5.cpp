//ORIGINAL_PATH: src/ctxindex.cpp----src/cmerkletx.cpp----src/cdisktxpos.cpp----src/ctransaction.cpp----src/calert.cpp----src/blocksizecalculator.cpp----src/blockparams.cpp----src/chainparams.cpp----src/version.cpp----src/velocity.cpp----src/txmempool.cpp----src/util.cpp
